...
# Configure CTIs so processor halt event will halt system peripherals, like watchdog timer
proc bf70x_configure_cti {} {
   # Unlock CTI0 (Proc CTI)
   # *pREG_CTI0_LAR = 0xC5ACCE55
   mww phys 0x20013FB0 0xC5ACCE55

   # Unlock CTI3 (System CTI)
   # *pREG_CTI3_LAR = 0xC5ACCE55
   mww phys 0x2001AFB0 0xC5ACCE55

   # Enable CTI0 (Proc CTI)
   # *pREG_CTI0_CTICONTROL = 1
   mww phys 0x20013000 0x1

   # Enable CTI3 (System CTI)
   # *pREG_CTI3_CTICONTROL = 1
   mww phys 0x2001A000 0x1

   # Connect DBGTRIGGER of proc to channel 0
   # *pREG_CTI0_CTIINEN0 = 1
   mww phys 0x20013020 0x1

   # Connect peripheral halt to channel 0
   # *pREG_CTI3_CTIOUTEN1 = 1
   mww phys 0x2001A0A4 0x1

   # Connect proc DBGRESTART to channel 1
   # *pREG_CTI0_CTIOUTEN7 = 2
   mww phys 0x200130BC 0x2

   # Connect peripheral DBGRESTART to channel 1
   # *pREG_CTI3_CTIOUTEN7 = 2
   mww phys 0x2001A0BC 0x2
}
