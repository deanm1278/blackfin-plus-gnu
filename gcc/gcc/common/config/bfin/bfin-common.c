...
EXPORTED_CONST struct bfin_cpu bfin_cpus[] =
{
  ...
  {"bf592", BFIN_CPU_BF592, 0x0000,
   ...
   {"bf700", BFIN_CPU_BF700, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf702", BFIN_CPU_BF702, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf704", BFIN_CPU_BF704, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf706", BFIN_CPU_BF706, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf701", BFIN_CPU_BF701, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf703", BFIN_CPU_BF703, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf705", BFIN_CPU_BF705, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},

   {"bf707", BFIN_CPU_BF707, 0x0001,
   WA_SPECULATIVE_LOADS | WA_05000074},
